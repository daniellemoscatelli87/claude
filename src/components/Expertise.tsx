    ...
    <section id="expertise" className="relative scroll-mt-24 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6">
        <div className="max-w-2xl animate-fade-up">
          ...
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-white sm:text-4xl">{ui.expertise.title}</h2>
            ...
            return (
              ...
              >
                <div>
                  ...
                  <h3 className="text-base font-semibold text-white">{item.title[lang]}</h3>
